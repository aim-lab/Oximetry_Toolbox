...
from DesaturationsMeasures_ import desat_embedding_
from ResultsClasses import HypoxicBurdenMeasuresResults


def CompHBMeasures_(signal, desaturations_signal, CT_Threshold, CA_baseline):
    ...
    desaturation_features = HypoxicBurdenMeasuresResults(CompCA_(signal, CA_baseline), CompCT_(signal, CT_Threshold),
                                                         0.0, 0.0, 0.0)
